...
<head>
    ...
    <title>Evalify : Between Dates Report </title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Quiz Report</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card alert">
                        <div class="card-body">
                            ...
                            <div class="card-header m-b-20">
                                <h4>Between Dates Report of Quiz</h4>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Uploaded Practicals Report</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                    <div class="col-lg-4 p-l-0 title-margin-left">
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="dashboard.php">Dashboard</a></li>
                                    <li class="active">Uploaded Practicals Report</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div id="main-content">
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="bwdates-report-assindetails.php" enctype="multipart/form-data">
                            <div class="card-header m-b-20">
                                <h4>Between Dates Report of uploaded Practicals</h4>
                                <div class="card-header-right-icon">
                                    <ul>
                                        <li class="card-close" data-dismiss="alert"><i class="ti-close"></i></li>
                                        <li class="card-option drop-menu"><i class="ti-settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
