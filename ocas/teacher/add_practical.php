...
$sql="insert into tblassigment(Tid,Cid,Sid,PracNum,PracTitle,PracDesc,SubDate,PracMarks,PracFile)values(:tid,:cid,:sid,:asgnnumber,:asstitle,:assdesc,:lsdate,:assmarks,:file)";
...
<head>
    ...
    <title>Evalify : Add Practicals </title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Practicals Information</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="basic-form">
                                        <div class="form-group image-type">
                                            <label>Practicals File  <span>(if any)</span></label>
